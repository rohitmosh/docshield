...
router.post('/upload', authMiddleware_1.requireEdit, DocumentController_1.DocumentController.uploadFile);
...
router.post('/:id/approve', authMiddleware_1.requireApprove, DocumentController_1.DocumentController.approveDocument);
