...
All tests conform to standard operating procedure guidelines.`;
    const doc1Enc = (0, cryptoUtils_1.encryptDocument)(doc1Content, 'Sasmita Dash');
    fileStmt.run('doc-1', 'Balimela_Unit3_Overhaul_Manual.pdf', 'PDF', 14500000, 'Technical', 'Generation', 'RESTRICTED', JSON.stringify(['turbine', 'overhaul', 'balimela']), 'v2.0', 'published', null, 10, 1775640000000, 1780824000000, 'Sasmita Dash', 'f-2', 'Balimela Power House Unit 3 mechanical logbooks. Servicing of turbine runner assembly, checking seal rings, shaft alignment, and governor settings.', allDepts, doc1Content, doc1Enc.ciphertext, doc1Enc.wrappedKey, doc1Enc.signature);
...
3. Recovery: Restore server images from encrypted daily backup archives.`;
    ...
    fileStmt.run('doc-6', 'IT_Security_Incident_Response_Plan.docx', 'DOCX', 3200000, 'Regulatory', 'IT', 'RESTRICTED', JSON.stringify(['security', 'incident', 'compliance']), 'v1.0', 'published', null, 5, 1767225600000, 1770024000000, 'System Administrator', 'root', 'Incident response procedures, escalation contact matrices, and recovery protocols for OHPC internal software assets.', allDepts, doc6Content, doc6Enc.ciphertext, doc6Enc.wrappedKey, doc6Enc.signature);
...
- Civil engineering and excavation: INR 35.1 Crores.`;
    ...
    fileStmt.run('doc-9', 'Balimela_Expansion_Budget_Estimates.xlsx', 'XLSX', 1200000, 'Financial', 'Finance', 'CONFIDENTIAL', JSON.stringify(['budget', 'finance', 'expansion']), 'v1.0', 'published', null, 5, 1767225600000, 1770024000000, 'System Administrator', 'f-3', 'Capacity addition budgets, vendor evaluation spreadsheets, and civil cost estimates for the Balimela expansion.', allDepts, doc9Content, doc9Enc.ciphertext, doc9Enc.wrappedKey, doc9Enc.signature);
...
- Critical relay trigger settings logged under restricted access credentials.`;
    ...
    fileStmt.run('doc-10', 'Transmission_Grid_Load_Dispatch_Log.xlsx', 'XLSX', 1600000, 'Technical', 'Transmission', 'SECRET', JSON.stringify(['load-dispatch', 'relay', 'protection']), 'v1.0', 'published', null, 10, 1767225600000, 1770024000000, 'System Administrator', 'f-6', 'Active load schedules, relay configuration, and protection trigger levels for transmission grids.', allDepts, doc10Content, doc10Enc.ciphertext, doc10Enc.wrappedKey, doc10Enc.signature);
